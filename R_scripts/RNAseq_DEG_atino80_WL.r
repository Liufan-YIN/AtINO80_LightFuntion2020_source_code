library(Hmisc)
library(DESeq2)
WT_1 <- read.delim("trim_WL_WT_1.rawcount")
WT_2 <- read.delim("trim_WL_WT_2.rawcount")
mu_1 <- read.delim("trim_WL_in80_1.rawcount")
mu_2 <- read.delim("trim_WL_in80_2.rawcount")
