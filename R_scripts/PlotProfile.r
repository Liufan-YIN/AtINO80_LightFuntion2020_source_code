ProfilePlot <- function(Path,colMeanDataA,colMeanDataB,DataAname,DataBname,mainname,filename,Ylim) {
setwd(Path)
pdf(filename)
...
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/",colMeans(WT_IP)/10,colMeans(mu_IP)/10,"WT","atino80","@H2A.Z","H2AZ_IP-input.pdf",c(0,8))
#[1] 1.12731e-22
#[1] 1.78391e-28
Target <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/HY5_regulate_genes/HY5_INO80_1/HY5_ino80_overlap.xls") 
...
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/HY5_ino80_1",WT_target,mu_target,"WT","atino80","@H2AZ in overlap","H2AZ_in_overlap.pdf",c(-2,10))
#[1] 1.41215e-24
#[1] 3.15699e-39
Target <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/HY5_regulate_genes/HY5_INO80_1/HY5_ino80_overlap_up.xls") 
WT_target <- subset(WT_IP,is.element(row.names(WT_IP),row.names(Target))==T)  
mu_target <- subset(mu_IP,is.element(row.names(mu_IP),row.names(Target))==T)
nrow(WT_target)#[1] 514
WT_target <- colMeans(WT_target)/10
mu_target <- colMeans(mu_target)/10
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/HY5_ino80_1",WT_target,mu_target,"WT","atino80","@H2AZ in overlap_up","H2AZ_in_overlap_up.pdf",c(-2,10))
#[1] 1.042385e-29
#[1] 1.092678e-47
...
WT_IP <- subset(WT_IP,is.element(row.names(WT_IP),genelist)==T) 
mu_IP <- subset(mu_IP,is.element(row.names(mu_IP),genelist)==T) 
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/",colMeans(WT_IP)/10,colMeans(mu_IP)/10,"WT","atino80","@H3","H3_IP-input.pdf",c(-2,6))
#[1] 5.220671e-27
#[1] 1.208631e-73
Target <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/HY5_regulate_genes/HY5_INO80_1/HY5_ino80_overlap.xls") 
WT_target <- subset(WT_IP,is.element(row.names(WT_IP),row.names(Target))==T)  
...
WT_target <- colMeans(WT_target)/10
mu_target <- colMeans(mu_target)/10
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/HY5_ino80_1",WT_target,mu_target,"WT","atino80","@H3 in overlap","H3_in_overlap.pdf",c(-2,10))
#[1] 8.609018e-21
#[1] 1.339471e-53
Target <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/HY5_regulate_genes/HY5_INO80_1/HY5_ino80_overlap_up.xls") 
WT_target <- subset(WT_IP,is.element(row.names(WT_IP),row.names(Target))==T)  
...
WT_target <- colMeans(WT_target)/10
mu_target <- colMeans(mu_target)/10
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/HY5_ino80_1",WT_target,mu_target,"WT","atino80","@H3 in overlap_up","H3_in_overlap_up.pdf",c(-2,10))
#[1] 4.653906e-21
#[1] 4.278609e-47
Target <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/HY5_regulate_genes/HY5_INO80_1/HY5_ino80_overlap_down.xls") 
WT_target <- subset(WT_IP,is.element(row.names(WT_IP),row.names(Target))==T)  
...
WT_target <- colMeans(WT_target)/10
mu_target <- colMeans(mu_target)/10
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/HY5_ino80_1",WT_target,mu_target,"WT","atino80","@H3 in overlap_down","H3_in_overlap_down.pdf",c(-2,10))
#[1] 6.593643e-19
#[1] 1.629341e-67
...
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/HY5_ino80_1",WT_target,mu_target,"WT","atino80","@H2AZ/H3 in overlap","H2AZvsH3_in_overlap.pdf",c(-2,10))
#[1] 7.697697e-05
#[1] 0.0005787423
Target <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/HY5_regulate_genes/HY5_INO80_1/HY5_ino80_overlap_up.xls") 
WT_target <- subset(WT,is.element(row.names(WT),row.names(Target))==T)  
...
WT_target <- 10*log2(colMeans(WT_target[,7:506])/colMeans(WT_target[,507:1006]))
mu_target <- 10*log2(colMeans(mu_target[,7:506])/colMeans(mu_target[,507:1006]))
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/HY5_ino80_1",WT_target,mu_target,"WT","atino80","@H2AZ/H3 in overlap_up","H2AZvsH3_in_overlap_up.pdf",c(-2,10))
#[1] 5.59668e-08
#[1] 2.307303e-07
Target <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/HY5_regulate_genes/HY5_INO80_1/HY5_ino80_overlap_down.xls") 
WT_target <- subset(WT,is.element(row.names(WT),row.names(Target))==T)  
...
WT_target <- 10*log2(colMeans(WT_target[,7:506])/colMeans(WT_target[,507:1006]))
mu_target <- 10*log2(colMeans(mu_target[,7:506])/colMeans(mu_target[,507:1006]))
ProfilePlot("/Volumes/OpheliaData/atino80/atino80_0317/ChIPseq2/Matrix/merge/profile/HY5_ino80_1",WT_target,mu_target,"WT","atino80","@H2AZ/H3 in overlap_down","H2AZvsH3_in_overlap_down.pdf",c(-2,10))
#[1] 0.1701653
#[1] 0.4878595