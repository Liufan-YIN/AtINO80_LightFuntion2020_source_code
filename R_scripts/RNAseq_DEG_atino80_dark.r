...
library(DESeq2)                                                                                                  
library(pheatmap)                                                                                                
setwd("/Volumes/OpheliaData/atino80/atino80_0317/RNAseq/Dark_atino80_sequence2/DEG/")
WT_1 <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/RNAseq/Dark_atino80_sequence2/DEG/count/trim_D_WT_1.rawcount")
WT_2 <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/RNAseq/Dark_atino80_sequence2/DEG/count/trim_D_WT_2.rawcount")
WT_3 <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/RNAseq/Dark_atino80_sequence2/DEG/count/trim_D_WT_3.rawcount")
mu_1 <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/RNAseq/Dark_atino80_sequence2/DEG/count/trim_D_in80_1.rawcount")
mu_2 <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/RNAseq/Dark_atino80_sequence2/DEG/count/trim_D_in80_2.rawcount")
mu_3 <- read.delim("/Volumes/OpheliaData/atino80/atino80_0317/RNAseq/Dark_atino80_sequence2/DEG/count/trim_D_in80_3.rawcount")
...
setwd("/Volumes/OpheliaData/atino80/atino80_0317/RNAseq/Dark_atino80_sequence2/DEG/15bei/")
